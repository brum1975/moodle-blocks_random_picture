...
/**
 * This file keeps track of upgrades to the random_picture block
 *
 * @since 2.0
 ...
 * @param object $block
 */
function xmldb_block_random_picture_upgrade($oldversion) {
    global $CFG, $DB;
    ...
    if ($oldversion < 2010071900) {
        ...
        $params['blockname'] = 'random_picture';
        ...
        /// random_picture block savepoint reached
        upgrade_block_savepoint(true, 2010071900, 'random_picture');
    }
